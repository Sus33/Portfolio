...
<header class="kotha-menu marketing-menu">
            ...
            <div class="menu-content">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="top-social-icons list-inline pull-right">
                        ...
                        <li class="top-search">
                            <a href="index.html#" class="sactive">
                    ...
                    <ul class="nav navbar-nav text-uppercase pull-left">
                        ...
                        <li><a href="WEB_INF/logins.jsp">Login</a></li>
                    </ul>
                </div>
    ...
    <div class="kotha-logo text-center">
        <h1><a href="index.html"><img src="assets/images/kotha-logo.png" alt="kothPro"></a></h1>
    </div>
</header>
            ...
            <div class="col-sm-4">
                <div class="kotha-sidebar">
                    ...
                    <aside class="widget add-widget">
                        ...
                        <div class="add-image">
                            <a href="index.html"><img src="assets/images/add-image.jpg" alt=""></a>
                        </div>
                    </aside>
                </div>
            </div>
...
<div class="container-fluid insta-feed text-center">
    <h2 class="text-uppercase">Follow@ <a href="index.html">Instagram</a></h2>
...
<footer>
    ...
    <div class="container-fluid text-center ft-copyright">
        <p>&copy; 2017 <a href="index.html">Kotha PRO </a> - Designed with <i class="fa fa-heart"></i> by <a
